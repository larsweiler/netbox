...
LABEL_UNIQUE = getattr(configuration, 'LABEL_UNIQUE', False)
LABEL_VALIDATION = getattr(configuration, 'LABEL_VALIDATION', False)
LABEL_VALIDATION_REGEX = getattr(configuration, 'LABEL_VALIDATION_REGEX', '^[ 0-9a-zA-Z#-.]*$')
